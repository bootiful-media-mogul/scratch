...
/**
 * entry point for all requests into the AI subsystem. supports the AiChat panel on the side of the screen.
 * not sure if this should be tied to a particular mogul's openai credentials or if we should just share the global one
 */
@Controller
class AiController {
